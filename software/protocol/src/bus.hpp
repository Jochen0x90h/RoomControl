...
enum class PlugType : uint16_t {
	...
	// open state of gate, door, window, blind, slat or valve (0: closed, 1: open, 2: toggle command)
	BINARY_OPEN = BINARY | 4 << 5,
	BINARY_OPEN_IN = BINARY_OPEN | IN,
	BINARY_OPEN_OUT = BINARY_OPEN | OUT,
	BINARY_OPEN_CMD_IN = BINARY_OPEN_IN | CMD,
	BINARY_OPEN_CMD_OUT = BINARY_OPEN_OUT | CMD,
	BINARY_OPEN_CATEGORY = 4095 << 1,
	// gate
	BINARY_OPEN_GATE = BINARY_OPEN | 1 << 1,
	BINARY_OPEN_GATE_IN = BINARY_OPEN_GATE | IN,
	BINARY_OPEN_GATE_OUT = BINARY_OPEN_GATE | OUT,
	BINARY_OPEN_GATE_CMD_IN = BINARY_OPEN_GATE_IN | CMD,
	BINARY_OPEN_GATE_CMD_OUT = BINARY_OPEN_GATE_OUT | CMD,
	// door
	BINARY_OPEN_DOOR = BINARY_OPEN | 2 << 1,
	BINARY_OPEN_DOOR_IN = BINARY_OPEN_DOOR | IN,
	BINARY_OPEN_DOOR_OUT = BINARY_OPEN_DOOR | OUT,
	BINARY_OPEN_DOOR_CMD_IN = BINARY_OPEN_DOOR_IN | CMD,
	BINARY_OPEN_DOOR_CMD_OUT = BINARY_OPEN_DOOR_OUT | CMD,
	// window
	BINARY_OPEN_WINDOW = BINARY_OPEN | 3 << 1,
	BINARY_OPEN_WINDOW_IN = BINARY_OPEN_WINDOW | IN,
	BINARY_OPEN_WINDOW_OUT = BINARY_OPEN_WINDOW | OUT,
	BINARY_OPEN_WINDOW_CMD_IN = BINARY_OPEN_WINDOW_IN | CMD,
	BINARY_OPEN_WINDOW_CMD_OUT = BINARY_OPEN_WINDOW_OUT | CMD,
	// blind
	BINARY_OPEN_BLIND = BINARY_OPEN | 4 << 1,
	BINARY_OPEN_BLIND_IN = BINARY_OPEN_BLIND | IN,
	BINARY_OPEN_BLIND_OUT = BINARY_OPEN_BLIND | OUT,
	BINARY_OPEN_BLIND_CMD_IN = BINARY_OPEN_BLIND_IN | CMD,
	BINARY_OPEN_BLIND_CMD_OUT = BINARY_OPEN_BLIND_OUT | CMD,
	// slat
	BINARY_OPEN_SLAT = BINARY_OPEN | 5 << 1,
	BINARY_OPEN_SLAT_IN = BINARY_OPEN_SLAT | IN,
	BINARY_OPEN_SLAT_OUT = BINARY_OPEN_SLAT | OUT,
	BINARY_OPEN_SLAT_CMD_IN = BINARY_OPEN_SLAT_IN | CMD,
	BINARY_OPEN_SLAT_CMD_OUT = BINARY_OPEN_SLAT_OUT | CMD,
	// valve
	BINARY_OPEN_VALVE = BINARY_OPEN | 6 << 1,
	BINARY_OPEN_VALVE_IN = BINARY_OPEN_VALVE | IN,
	BINARY_OPEN_VALVE_OUT = BINARY_OPEN_VALVE | OUT,
	BINARY_OPEN_VALVE_CMD_IN = BINARY_OPEN_VALVE_IN | CMD,
	BINARY_OPEN_VALVE_CMD_OUT = BINARY_OPEN_VALVE_OUT | CMD,
	// lock state of gate, door, window, (0: unlocked, 1: locked, 2: toggle command)
	...
	BINARY_ENABLE_CLOSE = BINARY | 8 << 5,
	...
	TERNARY_BUTTON = TERNARY | 1 << 5,
	TERNARY_BUTTON_IN = TERNARY_BUTTON | IN,
	TERNARY_BUTTON_OUT = TERNARY_BUTTON | OUT,
	TERNARY_BUTTON_CATEGORY = 2047 << 2,
	// mechanical button mounted on the wall
	TERNARY_BUTTON_WALL = TERNARY_BUTTON | 1 << 2,
	TERNARY_BUTTON_WALL_IN = TERNARY_BUTTON_WALL | IN,
	TERNARY_BUTTON_WALL_OUT = TERNARY_BUTTON_WALL | OUT,
	...
	// lock state of door, window, (0: unlocked, 1: tilt, 2: locked)
	TERNARY_LOCK = TERNARY | 4 << 5,
	TERNARY_LOCK_IN = TERNARY_LOCK | IN,
	TERNARY_LOCK_OUT = TERNARY_LOCK | OUT,
	TERNARY_LOCK_CMD_IN = TERNARY_LOCK_IN | CMD,
	TERNARY_LOCK_CMD_OUT = TERNARY_LOCK_OUT | CMD,
	...
	TERNARY_LOCK_DOOR_CMD_IN = TERNARY_LOCK_DOOR_IN | CMD,
	TERNARY_LOCK_DOOR_CMD_OUT = TERNARY_LOCK_DOOR_OUT | CMD,
	// window
	...
	TERNARY_LOCK_WINDOW_CMD_IN = TERNARY_LOCK_WINDOW_IN | CMD,
	TERNARY_LOCK_WINDOW_CMD_OUT = TERNARY_LOCK_WINDOW_OUT | CMD,
	...
	LEVEL_OPEN = LEVEL | 1 << 6,
	LEVEL_OPEN_IN = LEVEL_OPEN | IN,
	LEVEL_OPEN_OUT = LEVEL_OPEN | OUT,
	LEVEL_OPEN_CMD_IN = LEVEL_OPEN_IN | CMD,
	LEVEL_OPEN_CMD_OUT = LEVEL_OPEN_OUT | CMD,
	LEVEL_OPEN_CATEGORY = 1023 << 3,
	// gate level
	LEVEL_OPEN_GATE = LEVEL_OPEN | 1 << 3,
	LEVEL_OPEN_GATE_IN = LEVEL_OPEN_GATE | IN,
	LEVEL_OPEN_GATE_OUT = LEVEL_OPEN_GATE | OUT,
	LEVEL_OPEN_GATE_CMD_IN = LEVEL_OPEN_GATE_IN | CMD,
	LEVEL_OPEN_GATE_CMD_OUT = LEVEL_OPEN_GATE_OUT | CMD,
	// gate level
	LEVEL_OPEN_DOOR = LEVEL_OPEN | 2 << 3,
	LEVEL_OPEN_DOOR_IN = LEVEL_OPEN_DOOR | IN,
	LEVEL_OPEN_DOOR_OUT = LEVEL_OPEN_DOOR | OUT,
	LEVEL_OPEN_DOOR_CMD_IN = LEVEL_OPEN_DOOR_IN | CMD,
	LEVEL_OPEN_DOOR_CMD_OUT = LEVEL_OPEN_DOOR_OUT | CMD,
	// gate level
	LEVEL_OPEN_WINDOW = LEVEL_OPEN | 3 << 3,
	LEVEL_OPEN_WINDOW_IN = LEVEL_OPEN_WINDOW | IN,
	LEVEL_OPEN_WINDOW_OUT = LEVEL_OPEN_WINDOW | OUT,
	LEVEL_OPEN_WINDOW_CMD_IN = LEVEL_OPEN_WINDOW_IN | CMD,
	LEVEL_OPEN_WINDOW_CMD_OUT = LEVEL_OPEN_WINDOW_OUT | CMD,
	// blind level
	LEVEL_OPEN_BLIND = LEVEL_OPEN | 4 << 3,
	LEVEL_OPEN_BLIND_IN = LEVEL_OPEN_BLIND | IN,
	LEVEL_OPEN_BLIND_OUT = LEVEL_OPEN_BLIND | OUT,
	LEVEL_OPEN_BLIND_CMD_IN = LEVEL_OPEN_BLIND_IN | CMD,
	LEVEL_OPEN_BLIND_CMD_OUT = LEVEL_OPEN_BLIND_OUT | CMD,
	// slat level (e.g. slat of venetian blind)
	LEVEL_OPEN_SLAT = LEVEL_OPEN | 5 << 3,
	LEVEL_OPEN_SLAT_IN = LEVEL_OPEN_SLAT | IN,
	LEVEL_OPEN_SLAT_OUT = LEVEL_OPEN_SLAT | OUT,
	LEVEL_OPEN_SLAT_CMD_IN = LEVEL_OPEN_SLAT_IN | CMD,
	LEVEL_OPEN_SLAT_CMD_OUT = LEVEL_OPEN_SLAT_OUT | CMD,
	// valve level
	LEVEL_OPEN_VALVE = LEVEL_OPEN | 6 << 3,
	LEVEL_OPEN_VALVE_IN = LEVEL_OPEN_VALVE | IN,
	LEVEL_OPEN_VALVE_OUT = LEVEL_OPEN_VALVE | OUT,
	LEVEL_OPEN_VALVE_CMD_IN = LEVEL_OPEN_VALVE_IN | CMD,
	LEVEL_OPEN_VALVE_CMD_OUT = LEVEL_OPEN_VALVE_OUT | CMD,
	// battery level
