...
// ieee association request (hue lamp, request ack, receive on when idle)
...
// zbee default response ([1]: 0x61 = with acknowledge request, 0x41 = without acknowledge request, [4-5]: pan id)
uint8_t defaultResponse[] = {0, 0x41, 0x88, 0x2f, 0x62, 0x1a, 0x00, 0x00, 0x19, 0xed, 0x48, 0x02, 0x00, 0x00, 0x19, 0xed, 0x1e,
